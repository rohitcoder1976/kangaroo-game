...
function setup() {
  ...
  kangaroo=createSprite(width/3,height/1.3,20,20);
  kangaroo.addAnimation("running",kangaroo_running);
  kangaroo.addAnimation("collided",kangaroo_collided);
  kangaroo.setCollider("circle",0,200,300);
  //kangaroo.debug=true;
  kangaroo.scale=0.2;
 

  invisibleGround=createSprite(width/2,height/1.2,width,20);
...
function spawnShrubs() {
  ...
  if (frameCount % 150 === 0) {
    shrub=createSprite(width/2+400,invisibleGround.y-100);
